...
void _GetBonusAddrByInvestAddr(const Request &req, Response &res);
...
//vote==============================
void ApiPrintVoitInfo(const Request &req,Response &res);
void ApiPrintLockAddrs(const Request &req,Response &res);
void ApiPrintProposalInfo(const Request &req,Response &res);
void ApiPrintAvailableAssetType(const Request &req,Response &res);
void ApiGetAsseTypeByContractAddr(const Request &req,Response &res);
...
void GetProposal(const Request & req, Response & res);
void GetRevokeProposal(const Request & req, Response & res);
void GetVote(const Request & req, Response & res);
void _GetTreasury(const Request & req, Response & res);
//==================================

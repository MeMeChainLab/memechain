#ifndef _CA_SYNC_BLOCK_H_
#define _CA_SYNC_BLOCK_H_
...
private:
     ...
     * @return      int return 0 success 
     */
    static int _GetSyncBlockBySumHashNode(std::vector<std::string> &sendNodeIds, uint64_t startSyncHeight, uint64_t endSyncHeight, uint64_t selfNodeHeight, uint64_t chainHeight, uint64_t newSyncSnedNum);
     ...
     * @return      int return 0 success
     */
    static int _GetSyncBlockData(std::vector<std::string> &sendNodeIds, const std::vector<std::string> &reqHashes, uint64_t chainHeight);
    /**********************************************************************************************************************************/

...
#ifndef _EVM_ENVIRONMENT_H
#define _EVM_ENVIRONMENT_H
...
//    int64_t GetChainId();
    ...
    int MakeDeployMessage(const evmc_address &sender, const evmc_address &recipient, const std::string &gasType, evmc_message &message);
    ...
    int64_t CalculateBlockPrevRandao(const std::string &from, const std::string &gasType, bool isFindUtxo);
